...
@section('main_content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group row">{!! Form::label('current_password', __('users.attributes.current_password'), ['class' => 'col-sm-4 col-form-label']) !!}
            ...
            <div class="form-group row">
                {!! Form::label('password_confirmation',  'password_confirmation', ['class' => 'col-sm-4 col-form-label']) !!}

                <div class="col-sm-8">
                    {!! Form::password('password_confirmation', ['class' => 'form-control' . ($errors->has('password_confirmation') ? ' is-invalid' : ''), 'placeholder' => 'password_confirmation', 'required']) !!}
